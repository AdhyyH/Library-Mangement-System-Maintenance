...
<html lang="en">
  ...
  <head>
    ...
    <title>Room Record Reports</title>
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active" style="background-image: url(assets/img/book/book1.jpg)">
              <div class="carousel-container">
                <div class="container">
                  <h2  style="color: white;" class="animate__animated animate__fadeInDown">Room Rent Reports</h2>
                  <p class="animate__animated animate__fadeInUp"></p>

                  <!--input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by Title, ISBN or author" title="Type in a name"-->

                      <center>
        											<form name="RoomReport" action="<?php echo $RoomReservID ?>" method="POST">
        												<p>
        													<table id="tabledata">
        														<tr>
        															<th style="background-color: #ffd600;color:black;">ROOM RESERVE ID</th>
        															<td><input type="text" id="RoomReservID" name="RoomReservID" value="<?php echo $RoomReservID ?>" readonly></td>
        														</tr>

        														<tr>
        															<th style="background-color: #ffd600;color:black;">NAME</th>
        															<td><input type="text" id="BorrowerName" name="BorrowerName" value="<?php echo $BorrowerName?>" readonly></td>
        														</tr>

        														<tr>
        															<th style="background-color: #ffd600;color:black;">ROOM ID</th>
        															<td><input type="text" id="RoomID" name="RoomID" value="<?php echo $RoomID ?>" readonly></td>
        														</tr>

        					                  <tr>
        															<th style="background-color: #ffd600;color:black;">ROOM NAME</th>
        															<td><input type="text" id="RoomName" name="RoomName" value="<?php echo $RoomName ?>" readonly></td>
        														</tr>
       ...
       function downloadDoc()
       {
          html2canvas($("#tabledata")[0],
          {
            onrendered:function(canvas)
            {
              ...
              pdfMake.createPdf(docDefinition).download("RoomReport.pdf");
            }
          })
       }
