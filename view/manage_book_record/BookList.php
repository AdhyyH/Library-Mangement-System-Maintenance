...
if (isset($_GET['search'])) {
	...
	// If the search form is not submitted, use the original query
	$query = "SELECT Book_title, 
					Book_author, 
					publication_date, 
					totalPages, 
					...
					<nav id="navbar" class="navbar">
						<ul>
							...
							<li class="dropdown"><a href="#"><span>Menu</span> <i class="bi bi-chevron-down"></i></a>
								<ul>
									<li><a href="../manage_book_record/BookList.php">Manage Book Record</a></li>
						...
						<div class="container">
							...
							<center>
								...
								<form action="" method="GET">
									...
									<input type="submit" style="width: auto; padding: 10px; display: inline-block;" value="Search">
								</form>
									...
									<table class="table table-bordered table-striped mb-0">
										...
										?>
											<tr id="list">
												...
												<td><a id="redlinks" onclick="deleteBook()" href="deleteBookController.php?DeleteBook=<?php echo $ISBN ?>">Delete</a></td>
											</tr>
										<?php
										}
										?>
