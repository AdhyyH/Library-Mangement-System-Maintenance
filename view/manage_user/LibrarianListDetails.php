        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/book/book1.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Librarian Details</h2>
				...
				<input type="hidden" name="action" value="view">
					<center>
						<table>
							...
							<tr>
								<th>Name</th>
								<td><input type="text" id="name" name="name" value="<?php echo $name ?>" disabled></td>
							</tr>
							
							<tr>
								<th>Phone Number</th>
								<td><input type="text" id="phoneNum" name="phoneNum" value="<?php echo $phoneNum ?>" disabled></td>
							</tr>
						...
						<input type="button" id="backButton" name="Back" value="Back" onclick="location.href='./LibrarianList.php'"><br>
					</center>
